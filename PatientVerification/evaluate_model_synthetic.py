...
from dataset.SiameseDatasetSyntheticData import SiameseDatasetSyntheticData
...
test_set = SiameseDatasetSyntheticData(phase='testing', n_channels=3, n_samples=792294, transform=transform,
